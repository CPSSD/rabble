  ...
  return (
    <div>
      ...
      <div className="pure-u-10-24">
        ...
        <p>You can use Rabble to follow your favourite RSS feeds, and you can follow a Rabble blog from your own RSS reader as well. Rabble will also eventually support interacting with other ActivityPub-compliant services, like <a href="https://joinmastodon.org">Mastodon</a>, <a href="https://joinpeertube.org">PeerTube</a>, and <a href="https://plume-org.github.io/Plume/">Plume</a>.</p>

        <h4>Interested?</h4>
        <p>If you're interested in trying out Rabble, hit the <Link to="/register">Register</Link> button above to sign up to this server!</p>
        ...
        <p>Rabble was developed at Dublin City University by Aaron Delaney, Noah Ó Donnaile, Ross O'sullivan, and Cian Ruane, under the supervision of Dr. Jennifer Foster and Dr. Andrew McCarren.</p>
      </div>
    </div>
  );
};
